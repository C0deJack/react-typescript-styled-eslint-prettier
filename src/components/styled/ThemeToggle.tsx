        ...
        return (
            <StyledThemeToggle>
                ...
                <label htmlFor="checkbox" className="label">
                    ...
                    <svg className='moon' width="32px" height="32px" viewBox="-5 -2 32 32" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg">
                        <title>Dark theme</title>
                        <path fill='#f1c40f' d="M24.86,15.53a.5.5,0,0,0-.57,0A10.71,10.71,0,0,1,9.57.79.5.5,0,0,0,9,0,12.77,12.77,0,1,0,25,16,.5.5,0,0,0,24.86,15.53Z" />
                    </svg>
